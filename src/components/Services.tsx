...
export default function Services() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-[#04692F] text-white py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#04692F] rounded-3xl p-12 md:p-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-poppins">
              Expertise multidimensionnelle. Résultats concrets.
            </h1>
            <p className="text-xl mb-8 font-cabin leading-relaxed max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#04692F] px-8 py-3 text-lg font-semibold font-cabin rounded-lg transition-all duration-300">
                En savoir plus
              </Button>
              <Button className="bg-white text-[#04692F] hover:bg-gray-100 px-8 py-3 text-lg font-semibold font-cabin rounded-lg transition-all duration-300">
                Contactez-nous
              </Button>
            </div>
          </div>
      ...
      {/* Transition Section */}
      <section className="bg-[#1E1E1E] text-white py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 font-poppins">
            Trouvez le service qui vous correspond
          </h2>
          <p className="text-xl font-cabin mb-8 max-w-4xl mx-auto">
         ...
         <div className="max-w-6xl mx-auto">
           ...
           <div className="mb-16">
             <Image 
               ...
               width={1200}
               height={500}
               className="w-full h-[500px] object-cover object-top rounded-2xl shadow-2xl"
             />
           </div>
