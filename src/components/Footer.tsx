...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1E1E1E] text-white py-16 parallax-container">
      {/* Parallax decorative elements */}
      <div className="parallax-element top-10 left-10 w-24 h-24 bg-white/5 rounded-full animate-parallax-slow animate-delay-100"></div>
      <div className="parallax-element top-20 right-20 w-20 h-20 bg-white/10 rounded-full animate-parallax-medium animate-delay-300"></div>
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6 animate-fade-in-up animate-delay-500">
            ...
            <div className="space-y-3">
              <a 
                href="#" 
                className="flex items-center space-x-3 text-gray-300 hover:text-white transition-all duration-300 hover:translate-x-1"
              >
